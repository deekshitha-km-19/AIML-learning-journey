# 🏠 House Price Predictor - AI/ML Live Project
...
### 📊 Project Highlights
- Dataset: 1000+ Houses (Real Bangalore, Mysore, Mandya data)
- Model: Linear Regression - 85% Accuracy
- Features: Location, BHK, Sqft, Bathrooms
